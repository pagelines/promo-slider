...
class PageLinesSlider{
	...
	<div class="wrap" style="width:820px;"><div id="icon-options-general" class="icon32"><br /></div>
		<h2>Promo Slider 1.0 Settings</h2>
		<div class="metabox-holder" style="width: 820px; float:left;">
		<small>Welcome to Promo Slider 1.0</small>
		<div class="inside">
			<br />
		</div>
	</div>
	...
	function promo_slider(){
		...
		if($slider_status == 'on'){
			...
			echo '<link rel="stylesheet" href="'.CURR_PLUG_IN_URL.'/maincss.css" />';
